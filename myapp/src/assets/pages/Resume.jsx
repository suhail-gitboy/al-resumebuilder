...
onClick={Handleupdated}    >
 ...
 {
  isLogin? <SwitchtypePdf/> :<button className='bg-indigo-600 text-white px-6 py-2 rounded-lg shadow hover:bg-indigo-700 transition-all"' onClick={()=>Setmodallogin(true)}>
      login to download
    </button>
 }
 ...
 <div>
  <Link className="flex justify-center items-center px-9 py-2   bg-linear-to-r from-blue-600 to-blue-800 text-white  rounded-lg font-medium shadow-md hover:shadow-xl hover:scale-105 transition-transform duration-200 " to={`/preview/${resumetype}`}><FaEye className='text-xl ml-2 mr-2'/> view</Link>
 </div>
</div>
{Switchresume()}
